...
<%
   ...
   //if(session != null && v_loginYn.equals("N")){ //&& v_loginYn.equals("N")
	HashMap hmp = (HashMap)session.getAttribute("SESSION");
/* 	if(hmp !=null){
			String v_user_id = (String)hmp.get("user_id")==null?"":(String)hmp.get("user_id");
			out.println("세션 :" + hmp);
			out.println("::로그인됨::::"+v_user_id);
